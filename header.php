      ...
      <div class="row">
        ...
        <div class="eight columns slimhead">
            <nav class="right">
	          ...
	          <span class="right subheader"><span class="label tertiary">Call - 033 33 707 247</span> or <span class="label success"><a href="mailto:name@domain.com">jobs@workforeveryhome.co.uk</a></span></span>
        </div>
      </div>
